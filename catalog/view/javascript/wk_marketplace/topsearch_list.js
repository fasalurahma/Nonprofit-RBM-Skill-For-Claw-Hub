      ...
      if (json['success']) {
        ...
        for (var i = 0; i < topsearch.length; i++) {
          ...
          if(topsearch[i]['offer']) {
            htm += '<a class="btn" href ="' + topsearch[i]['offer'] + '"  data-toggle="tooltip" title="'+json['help_offer']+'" style="background-color:rgb(90,90,90);color: white;border: 0px none; border-radius: 0px;">  '+json['entry_offer']+' ';

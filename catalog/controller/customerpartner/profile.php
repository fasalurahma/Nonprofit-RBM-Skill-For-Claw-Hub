	...
	public function index() {
	  ...
	  if(!empty($data['achivment'])){
		...
		if (isset($partner['companydescription']) && $partner['companydescription']) {
			 $partner['companydescription'] = strip_tags(html_entity_decode($partner['companydescription'], ENT_QUOTES, 'UTF-8'));
		}

		if (isset($partner['shortprofile']) && $partner['shortprofile']) {
			 $partner['shortprofile'] = strip_tags(html_entity_decode($partner['shortprofile'], ENT_QUOTES, 'UTF-8'));
		}
